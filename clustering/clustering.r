...
mydata <- mydata[which(mydata$region == 'Sub-Saharan Africa' | 
                       mydata$country == 'Algeria' |
                       mydata$country == 'Djibouti' |
                       mydata$country == 'Egypt, Arab Rep.' |
                       mydata$country == 'Libya' |
                       mydata$country == 'Morocco' |
                       mydata$country == 'Tunisia' 
                         ),]
...
rm(data, country_info, fit, iso3, long, mydata, folder, path,
...
gde_15 <- subset(gde_15, continent=="Africa") #gde_15[which(gde_15$continent == 'Africa'), ]
