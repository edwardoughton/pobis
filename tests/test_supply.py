...
def test_estimate_site_upgrades(
    ...
    assert answer['existing_network_sites'] == 50
    ...
    assert answer['existing_network_sites'] == 100
    ...
    assert answer['existing_network_sites'] == 0
    ...
    assert answer['existing_network_sites'] == 10
