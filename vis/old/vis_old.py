...
path_countries = os.path.join(DATA_RAW, 'gadm36_levels_shp', 'gadm36_0.shp')

if os.path.exists(path_countries):
    countries = gpd.read_file(path_countries)
else:
    print('Could not find GADM country layer' )
...
def find_country_list(countries, continent_list):
    """

    """
    # path_processed = os.path.join(DATA_RAW, 'gadm36_levels_shp', 'gadm36_0.shp')
...
if __name__ == '__main__':
    ...
    for graphic in graphics:
        ...
        country_list = find_country_list(countries, [continent])
